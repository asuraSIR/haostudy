        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="commoncases" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="常用案例" lay-direction="2">
                            <i class="layui-icon layui-icon-app"></i>
                            <cite>常用案例</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd data-name="editor">
                                <a lay-href="/casepage/jsp/richtexteditor_richtexteditorview.do">富文本编辑器</a>
                            </dd>
                            <dd>
                                <a lay-href="/casepage/jsp/fileuploadanddownload_index.do">文件上传下载</a>
                            </dd>
                    ...
                    <li data-name="pageframework" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="前端框架" lay-direction="2">
                            <i class="layui-icon layui-icon-template"></i>
                            <cite>前端框架</cite>
                        </a>
                        <dl class="layui-nav-child">
                            <dd><a href="/uitemplate/AdminLTE/index2.html" target="_blank">AdminLTE</a></dd>
                            <dd><a href="/uitemplate/layuiAdmin/views/index.html" target="_blank">layuiAdmin</a></dd>
                            <dd><a href="/uitemplate/ueditor/index.html" target="_blank">ueditor</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
